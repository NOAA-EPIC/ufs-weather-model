...
sdfopen orig-results-001/atmf2184.nc
...
d ugrd.2
run cbar.gs
draw title Jet stream (test 1)
printim jet-test1.png x1200 y1000
c

set grads off
set clevs -20 -10 -5 -2 0 2 5 10 20
d ugrd.2-ugrd.1
run cbar.gs
draw title Jet stream diff (test 1 - control)
printim jet-diff-test1.png x1200 y1000
c
*----------------------------------------------
...
d tmp.2-273
run cbar.gs
draw title Temp 500hPa (test 1)
printim tmp-test1.png x1200 y1000
c

set grads off
set clevs -5 -2 -1 -0.5 0.5 1 2 5
d tmp.2-tmp.1
run cbar.gs
draw title Temp 500hPa diff (test 1 - control)
printim tmp-diff-test1.png x1200 y1000
c
*----------------------------------------------
...
sdfopen orig-results-001/sfcf2184.nc
*----------------------------------------------
...
d prate_ave.2*86400
run cbar.gs
draw title Precip mm/day (test 1)
printim prec-test1.png x1200 y1000
c

set grads off
set clevs -0.1 -0.05 -0.02 -0.01 0.01 0.02 0.05 0.1
d prate_ave.2*86400-prate_ave.1*86400
run cbar.gs
draw title Precip mm/day (test 1 - control)
printim prec-diff-test1.png x1200 y1000
c
