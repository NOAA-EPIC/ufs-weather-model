...
def create_summary():
   ...
   for category in categories: 
      ...
      mdFile.new_paragraph('&nbsp;&nbsp;&nbsp;&nbsp;✅ = <span style="color: green;">NORMAL</span>' + f" {category}. {category.title()} falls within two standard deviations of the mean.")
      mdFile.new_paragraph(f"&nbsp;&nbsp;&nbsp;&nbsp;⚠️ = {category.title()} " '<span style="color: yellow;">WARNING</span>: ' + f"{category.title()} is greater than two standard deviations above the mean.")
      mdFile.new_paragraph(f"&nbsp;&nbsp;&nbsp;&nbsp;❌ = {category.title()} " '<span style="color: red;">FAIL</span>: ' + f"For the past 2+ PRs, {category} has been greater than two standard deviations above the mean.")
      mdFile.new_paragraph('\n')
