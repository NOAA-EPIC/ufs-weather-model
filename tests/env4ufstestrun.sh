...
#export PATHTR=$PWD/..
export PATHTR="${PATHTR:-/work/noaa/epic/nperlin/scratch/orion/UFS-WM/ufs-wm-gnu}"
echo "PATHTR = $PATHTR"
read -p "  ...press Enter to keep, or type new value: " INPUT
if [[ -n "$INPUT" ]]; then
    export PATHTR="$INPUT"
...
export DISKNM="${DISKNM:-/work2/noaa/epic/UFS-WM_RT}"
echo "DISKNM = $DISKNM"
read -p "  ...press Enter to keep, or type new value: " INPUT
if [[ -n "$INPUT" ]]; then
    export DISKNM="$INPUT"
...
#export INPUTDATA_ROOT=/work2/noaa/epic/UFS-WM_RT/NEMSfv3gfs/input-data-20251015
...
export INPUTDATA_ROOT_WW3=${INPUTDATA_ROOT}/WW3_input_data_20250807
